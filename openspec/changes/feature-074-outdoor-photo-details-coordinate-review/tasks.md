...
- [x] 2.3 Add the authorized owner/creator/admin coordinate-review mode with existing candidate explanations, approval, rejection, manual override validation, pending states, and clear unavailable-state feedback.
...
- [x] 3.2 Add focused deterministic coverage or checks for authorized detail projection, unauthorized metadata denial, direct-EXIF versus approved-inferred provenance, and direct coordinate-review action denial.
