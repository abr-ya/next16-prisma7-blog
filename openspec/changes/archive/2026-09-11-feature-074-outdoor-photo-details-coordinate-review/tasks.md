...
- [x] 3.4 Confirm the local production build. Defer administrator EXIF refresh, coordinate-modal scrolling, candidate approval/rejection, manual correction, and map-focus QA to `outdoor-track-source-timezone-selection`, because current track-time display is not yet a reliable coordinate-review baseline.
