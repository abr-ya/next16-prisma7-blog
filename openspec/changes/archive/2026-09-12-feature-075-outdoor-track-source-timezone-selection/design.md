...
- Date labels can influence human coordinate review → preserve all matching inputs as absolute instants; the explicit coordinate-review context is handled by feature-076. Ambiguous GPX/EXIF source timestamp correction remains deferred.
