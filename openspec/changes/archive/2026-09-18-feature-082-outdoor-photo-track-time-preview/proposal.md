...
- Let the reviewer select temporary offsets from the stored capture time in one-hour steps from -3 to +3 hours and see the recalculated point on that candidate's source track.
