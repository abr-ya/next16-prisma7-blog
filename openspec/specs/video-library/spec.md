...
Admins SHALL be able to create and edit video records with title, external URL, thumbnail URL, channel, visibility, and video date fields.
...
- **THEN** the system SHALL update the title, URL, thumbnail URL, channel, video date, and visibility values
