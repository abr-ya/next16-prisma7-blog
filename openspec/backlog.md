...
| 24 | In Progress | feature-074-outdoor-photo-details-coordinate-review | outdoor/maps-photos | Let authorized trip-photo viewers inspect extracted EXIF and coordinate provenance from the gallery; let only the photo owner or an administrator refresh EXIF and review track-time coordinates through compact card controls and focused modals. |
