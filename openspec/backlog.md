...
| In Progress | feature-071-public-user-profile | navigation/public-users | Add a signed-in `/profile` with one editable profile avatar, personal content links/counts, and the private invitation entry point; defer multiple/per-content avatars and public profiles. |
