...
| In Progress | feature-077-outdoor-trip-photo-add-header | outdoor/trips-photos | Move the authorized public trip `Add photo` action from the bottom contribution panel into the Photos section header, while preserving existing contribution rules and feedback. |
