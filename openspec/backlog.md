...
| 14 | In Progress (`feature-069`) | outdoor-hike-to-trip-domain-rename | outdoor/domain | Rename the hike-centered domain to `Trip` for city walks and existing outdoor types, preserving data and legacy URLs through mapped storage and redirects. |
