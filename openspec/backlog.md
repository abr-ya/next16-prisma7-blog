...
| --- | --- | --- | --- | --- |
| 3 | In Progress | feature-048-outdoor-tracks-public-download-preview | outdoor/tracks | Add public track listing/detail pages with visibility-safe metadata and controlled access to public GPX files. |
