...
| Candidate | outdoor-trip-photo-lightbox-overlay-polish | outdoor/photos | Polish the authenticated trip photo lightbox: show the current photo number and total (for example, `3 of 12`), and show/hide photo details as a compact semi-transparent overlay over the image instead of expanding the dialog. Opening or closing details SHALL not change dialog geometry or require scrolling. |
