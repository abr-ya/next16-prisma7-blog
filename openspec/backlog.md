...
| --- | --- | --- | --- | --- |
| 4 | In Progress | feature-051-outdoor-photos-file-data-foundation | outdoor/photos | Add the first `Photo` entity backed by image `FileAsset` records, 1-3 file upload batch support, data actions, and admin create/edit/list page. |
