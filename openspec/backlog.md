...
| In Progress | feature-082-outdoor-photo-track-time-preview | outdoor/maps-photos | In the owner-or-admin coordinate-review modal, show an inside-track candidate on a compact protected map and let reviewers temporarily preview capture-time offsets from -2 to +2 hours. Keep the offset non-persistent; do not rerun matching across tracks or alter approval inputs. |
