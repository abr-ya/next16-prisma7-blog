...
| 16 | In Progress | feature-072-outdoor-trip-public-photo-upload | outdoor/trips-photos | Let trip creators and accepted participants upload photos directly from a public trip detail page and attach them to the trip, with a default 10-photo-per-user-per-trip contribution limit. |
| 24 | In Progress | feature-074-outdoor-photo-details-coordinate-review | outdoor/maps-photos | Let authorized trip-photo viewers inspect extracted EXIF and coordinate provenance from the gallery, and let the photo owner, trip creator, or administrator review track-time coordinate candidates from the same dialog. |
