...
| Candidate | public-user-workspace-menu-planning | navigation/public-users | Plan a signed-in public user menu that groups personal surfaces: My trips, My tracks, My photos, My posts, and My invitations. Define information architecture, empty states, privacy/ownership rules, route scope, mobile behavior, and whether the menu is a header dropdown or dedicated workspace page before implementation. Keep admin controls separate. |
