...
| feature-017 | Cancelled | feature-017-file-sharing-structure | files/architecture | Renumbered to `feature-015-file-sharing-structure`; do not reuse this number. |
...
| feature-022 | Planned | feature-022-admin-roles-structure | admin/auth | Define admin/user roles and permissions before expanding file ownership, storage quotas, and global admin controls. |
