          ...
          <Tabs defaultValue="upload" className="px-3">
            ...
            <TabsContent value="url">
              <form onSubmit={handleInsertEmbed}>
                ...
                />
                {urlError && <p className="py-1.5 text-xs text-danger-11">Please enter a valid URL</p>}
                <Button onClick={handleInsertEmbed} type="button" size="sm" className="my-2 h-8 w-full p-2 text-xs">
                  Embed Image
                </Button>
                <p className="text-center text-xs text-gray-11">Works with any image from the web</p>
              </form>
            </TabsContent>
          </Tabs>
        </PopoverContent>
